...
if (numero >= 0) { // Verificar o tipo de 'numero' antes de fazer a comparação (false está sendo considerado como zero)
...
if (typeof numero === 'number' && numero >= 0) { // Comprarando antes de fazer a comparação
    console.log('Sim o numero é maior ou igual a zero');
} else {
