...
// A unica coisa que você quer com uma função é mandar um valor pra ela e geralmente pegar um valor de volta
// Tem funções que não retorna valor também!


function saudacao1(nome, idade) { // Função usando parametros para receber valores. (Como uma variável)
...
function saudacao2(nome, idade) { // Função usando parametros para receber valores. (Como uma variável)
